 ...
 * generated in the fr.careco.aaa.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _NumeroImmatriculationInconnuMessage_QNAME = new QName("http://aaa.asso.fr/sivin/schemas", "message");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.careco.aaa.ws
     * 
     */
    ...
    public JAXBElement<String> createNumeroImmatriculationInconnuMessage(String value) {
        return new JAXBElement<String>(_NumeroImmatriculationInconnuMessage_QNAME, String.class, NumeroImmatriculationInconnu.class, value);
    }
    ...
    public JAXBElement<String> createNumeroSirenInconnuMessage(String value) {
        return new JAXBElement<String>(_NumeroImmatriculationInconnuMessage_QNAME, String.class, NumeroSirenInconnu.class, value);
    }
    ...
    public JAXBElement<String> createQuotaMessage(String value) {
        return new JAXBElement<String>(_NumeroImmatriculationInconnuMessage_QNAME, String.class, Quota.class, value);
    }
    ...
    public JAXBElement<String> createNumeroVinInconnuMessage(String value) {
        return new JAXBElement<String>(_NumeroImmatriculationInconnuMessage_QNAME, String.class, NumeroVinInconnu.class, value);
    }
    ...
    public JAXBElement<String> createBaseDeDonneeInaccessibleMessage(String value) {
        return new JAXBElement<String>(_NumeroImmatriculationInconnuMessage_QNAME, String.class, BaseDeDonneeInaccessible.class, value);
    }
