...
@Entity
@Table(name = "AutorisationB2C")
@NamedQueries(value = { 
		@NamedQuery(name=AutorisationB2C.QN.FIND_BY_LOGIN, query="select f from AutorisationB2C f where f.loginAuthen = :login and f.mdpAuthen = :pwd")
		})
public class AutorisationB2C implements java.io.Serializable {
	
	public static class QN {
		public static final String FIND_BY_LOGIN = "AutorisationB2C.findByLogin";
	}
