...
@Entity
@Table(name = "Log_Appel_B2C")
@NamedQueries(value = { 
		@NamedQuery(name=LogAppelB2C.QN.FIND_BY_LOGIN, query="select f from LogAppelB2C f where f.Login_Log = :login"),
		@NamedQuery(name=LogAppelB2C.QN.FIND_BY_DATE, query="select f from LogAppelB2C f where f.Date_Log between :debut and :fin"),
		@NamedQuery(name=LogAppelB2C.QN.FIND_BY_LOGIN_DATE, query="select f from LogAppelB2C f where f.Login_Log = :login and f.Date_Log between :deb and :fin")
		})
public class LogAppelB2C implements java.io.Serializable {
	
	public static class QN {
		public static final String FIND_BY_LOGIN = "LogAppelB2C.findByLogin";
		public static final String FIND_BY_DATE = "LogAppelB2C.findByDate";
		public static final String FIND_BY_LOGIN_DATE = "LogAppelB2C.findByLoginDate";
	}

	private static final long serialVersionUID = 4902916262554633211L;
