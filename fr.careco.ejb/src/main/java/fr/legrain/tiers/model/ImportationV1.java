...
@Entity
@Table(name = "ImportationV1")
@EntityListeners({MyListener.class})
public class ImportationV1 implements java.io.Serializable, ILgrEntity {
		
	private static final long serialVersionUID = -8919701184015242401L;
	...
	public String getTableCourante() {
	...
	public void setTableCourante(String tableCourante) {
		this.tableCourante = tableCourante;
	}
	...
	public ImportationV1(String tableOrigine, Integer idOrigine,
			String tableCourante, Integer idCourant) {
		super();
		this.tableOrigine = tableOrigine;
		this.idOrigine = idOrigine;
		this.tableCourante = tableCourante;
