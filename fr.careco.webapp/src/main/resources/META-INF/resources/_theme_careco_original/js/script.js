$(document).ready(function() {
    ...
    //$("#widget_TABSINFOS").wl_Widget({"collapsed":"true"})
    /*----------------------------------------------------------------------*/
    /* All Form Plugins
		/*----------------------------------------------------------------------*/
    ...
    /*$('#widget_TABSINFOS').accordion({
        //collapsible:true,
        collapsible: true,
        active: false
    });*/
    //$('#widget_accordionResultat').wl_Widget();
    //alert($("#searchType").val());
    //$content.find('div.accordion').accordion( "option", "active", 0);
